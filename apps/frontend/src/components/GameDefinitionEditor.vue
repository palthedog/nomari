      ...
      <div class="header-controls">
        ...
        <div class="form-group">
          ...
          <select v-model="gameDefinition.rootSituationId">
            ...
            >
              {{ situation.situationId }} - {{ situation.description || '(説明なし)' }}
            </option>
            <option
            ...
            >
              {{ terminal.situationId }} - {{ terminal.name || '(名前なし)' }} (Terminal)
            </option>
          </select>
        </div>
      </div>
      ...
      <div class="left-panel">
        ...
        <div class="panel-content">
          ...
          <div class="section-group">
            <div
              class="section-item initial-state-item"
              :class="{ active: selectedItemType === 'initial-state' }"
